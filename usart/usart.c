...
int16_t usartParseInt()
{
	...
	{
		c = usartGetChar(); // eliminisemo taj znak
	}
	...
	res = res * 10 + (c - '0'); //npr '4' - '0' = 52 - 48 = 4;
	//npr izdvaja se broj 123
	//1. iteracija petlje: res =0; res =0*10+('1'-'0') = 0+1=1
	//2. iteracija petlje: res =1; res =1*10+('2'-'0') = 10+2=12
	//3. iteracija petlje: res =12; res =12*10+('3'-'0') = 120+3=123
